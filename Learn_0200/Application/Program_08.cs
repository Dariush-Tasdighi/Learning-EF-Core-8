...
//		else
//		{
//			var state1 = applicationDbContext.Entry(entity: foundCategory).State;

//			// با اجرای دستور ذیل، هیچ اتفاقی رخ نمی‌دهد
//			// در این خصوص بعدا خیلی بیشتر توضیح خواهم داد
//			foundCategory.Name = "Category 1";

//			var state2 = applicationDbContext.Entry(entity: foundCategory).State;

//			foundCategory.Name = "New Category Name!";

//			var state3 = applicationDbContext.Entry(entity: foundCategory).State;

//			foundCategory.Name = "Category 1";

//			var state4 = applicationDbContext.Entry(entity: foundCategory).State; // Modified!

//			applicationDbContext.SaveChanges();

//			var state5 = applicationDbContext.Entry(entity: foundCategory).State;
//		}
//	}
//	//**************************************************
...
//		var affectedRows = applicationDbContext.Database.ExecuteSqlRaw(sql: sql);
...
//		if (foundCategory is null)
//		{
//			var errorMessage = $"There is not any category with this Id (1)!";
...
//			// کار نمی‌کند
//			var affectedRows = applicationDbContext.SaveChanges();
...
//			new Category
//			{
//				Id = 1, // برابر مقداری می‌گذاریم، که اطمینان داریم، در بانک اطلاعاتی وجود دارد
//				IsActive = true,
//				Name = "New Category",
//			};

//		var state1 = applicationDbContext.Entry(entity: theCategory).State;

//		applicationDbContext.Entry(entity: theCategory).State = EntityState.Modified;

//		var state2 = applicationDbContext.Entry(entity: theCategory).State;

//		var affectedRows = applicationDbContext.SaveChanges();

//		var state3 = applicationDbContext.Entry(entity: theCategory).State;
//	}
//	// **************************************************
